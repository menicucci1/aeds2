...
public class DAO {
    ...
    public boolean inserirUsuario(Carro usuario) {
        boolean status = false;
        try {
            Statement st = conexao.createStatement();
            st.executeUpdate("INSERT INTO usuario (nome, marca, cpf, cor) "
                    + "VALUES (" + usuario.getNome() + ", '" + usuario.getMarca() + "', '"
                    + usuario.getCpf() + "', '" + usuario.getCor() + "');");
            st.close();
            status = true;
    ...
    public Carro[] getUsuariosMasculinos() {
        Carro[] usuarios = null;
